      ...
      <div className="mt-5 flex flex-wrap gap-2">
        ...
        {allowPublish ? (
          <button
            ...
            className="inline-flex items-center gap-2 rounded-full bg-brand-700 px-4 py-2.5 text-sm font-semibold text-white hover:bg-brand-800 disabled:opacity-45"
          >
            {busy === "publish" ? (
              <LoaderCircle className="h-4 w-4 animate-spin" />
            ) : null}
